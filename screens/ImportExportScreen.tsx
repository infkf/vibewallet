    ...
    <ScrollView contentContainerStyle={{ padding: 16 }}>
      <Card style={{ marginBottom: 16 }}>
        ...
        <Card.Content>
          <Text variant="bodyMedium" style={{ marginBottom: 8 }}>
            Import from Money Tracker JSON (e.g., extracted database.json) or
            this app&apos;s own export.
          </Text>
          <Button mode="contained" onPress={() => pickAndImport(setData, data)}>
            Pick JSON file
          </Button>
        </Card.Content>
      </Card>
      ...
      <Card style={{ marginBottom: 16 }}>
        ...
        <Card.Content>
          ...
          <Button mode="contained" onPress={() => exportData(data)}>
            Export JSON
          </Button>
        </Card.Content>
      </Card>
      ...
      <Card>
        ...
        <Card.Content>
          <Button mode="contained" buttonColor="red" onPress={resetData}>
            Reset all data
          </Button>
        </Card.Content>
      </Card>
